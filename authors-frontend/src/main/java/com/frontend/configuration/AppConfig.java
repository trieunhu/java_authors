...
import com.frontend.widgets.MainPreparer;

@Configuration
@EnableWebMvc
@ComponentScan({ "com.frontend" })
...
public class AppConfig extends WebMvcConfigurerAdapter {
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		...
		registry.addResourceHandler("/images/**").addResourceLocations("file:"+environment.getProperty("pathDirectoryImage"));
	}
	@Bean
